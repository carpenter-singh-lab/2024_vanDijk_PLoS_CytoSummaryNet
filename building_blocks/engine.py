...
def train_loop(model, trainloader, valloader, loss_func, optimizer, device, epochs, nr_cells, wandb, save_path):
    ...
    for e in range(epochs):
        ...
        print(f"Epoch {e}. Train loss: {tr_loss}. Val loss: {val_loss}. Val mAP: {val_mAP}")
        ...
        wandb.log({"Val loss": val_loss, "Val mAP": val_mAP, "best_val_mAP": best_val}, step=e)
