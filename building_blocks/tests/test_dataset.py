...
def mock_pkl_data():
    return {
        "cell_features": pd.DataFrame(np.random.rand(100, 10))  # 100 cells x 10 features
    }
...
@patch("pickle.load")
def test_load_group_samples(mock_pickle_load, mock_file, mock_metadata_df, mock_pkl_data):
