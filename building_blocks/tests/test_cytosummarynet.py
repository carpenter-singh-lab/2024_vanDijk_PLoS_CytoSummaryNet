...
@patch("pickle.load")
def test_integrated_pipeline(mock_pickle_load, mock_file, mock_metadata_df, mock_pkl_data):
    """
    ...
    for initial, trained in zip(initial_params, trained_model.parameters()):
        assert not torch.equal(initial, trained), "Model parameters did not update during training!"
