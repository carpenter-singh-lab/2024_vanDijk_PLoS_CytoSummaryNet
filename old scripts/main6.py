...
#%%
run = wandb.init(project="FeatureAggregation", mode='offline', tags=['Generalized Models'])  # 'dryrun'
...
BS = 16  # batch size as passed to the model (nr of wells that you sample per batch)
...
plates = ['BR00112197standard_FS', 'BR00112199_FS', 'BR00112197repeat_FS', 'BR00112203_FS', 'BR00113820_FS', 'BR00112197binned_FS']
...
for i, pDir in enumerate(plateDirs):
    ...
    TrainLoaders.append(DataloaderTrainV5(TrainTotal, nr_cells=nr_cells, nr_sets=nr_sets) )
    ValLoaders.append(DataloaderTrainV5(ValTotal, nr_cells=nr_cells, nr_sets=nr_sets) )
