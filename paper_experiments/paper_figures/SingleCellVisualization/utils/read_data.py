...
def readSingleCellData_sqlalch_FeatureAndWell_subset(fileName, selected_feature, wells, compartments):
...
#     selected_feature='Cells_Intensity_IntegratedIntensity_DNA'
    ...
    format("TableNumber, ImageNumber, well", "Image", 'well', list_str)
    ...
    query_cols = "TableNumber, ImageNumber, Metadata_Plate, "+selected_feature + filename_column_names+ pathname_column_names + other_column_names#+", "+f2
