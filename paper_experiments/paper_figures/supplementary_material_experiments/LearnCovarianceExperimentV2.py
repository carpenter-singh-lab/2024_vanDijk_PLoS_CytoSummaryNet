...
from src.dataloader_pickles import DataloaderTrainVX, DataloaderEvalV5
import utils
...
for e in range(epochs):
    ...
    for idx, data in enumerate(
        tqdm(
            zip(TrainLoaders[0], TrainLoaders[1], TrainLoaders[2]),
    ...
    torch.save(
        ...
        os.path.join(
            "/Users/rdijk/Documents/ProjectFA/InterpretabilityAnalysis/LearningCovarianceMatrices/models",
            model_name,
        ),
    )
