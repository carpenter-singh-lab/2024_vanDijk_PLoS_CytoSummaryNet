...
# Internal Modules
from old_networks.PointCNN_util_funcs import UFloatTensor, ULongTensor, knn_indices_func_gpu
from old_networks.PointCNN_util_layers import Conv, SepConv, Dense, EndChannels
...
class Classifier(nn.Module):
    ...
    def __init__(self):
        ...
        self.pcnn1 = AbbPointCNN(1938, 2000, 8, 1, -1)
        self.pcnn2 = nn.Sequential(
            AbbPointCNN(2000, 1500, 8, 2, -1),
            AbbPointCNN(1500, 1000, 8, 4, -1),
            AbbPointCNN(1000, 900, 12, 4, 120),
            AbbPointCNN(900, 800, 12, 6, 120)
        )
