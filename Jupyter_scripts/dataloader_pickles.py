...
class DataloaderEvalSaliency(Dataset):
...
# TODO
        random_indices = np.random.choice(features.shape[0], 3000)
        features_select = features[random_indices, :]

# TODO
        # Append to list of sampled features
        features = torch.tensor(features_select, dtype=torch.float32)
...
# TODO
        # random_indices = np.random.choice(features.shape[0], 5000)
        # features_select = features[random_indices, :]
